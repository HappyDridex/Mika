...
const DishCard = (props: IDishCardProps) => {
    ...
    return (
        <div onClick={onClick} className="flex h-full w-full cursor-pointer flex-col justify-between gap-3">
            <div
            ...
            <div className="flex h-full flex-col justify-between">
                ...
                {/* price is hidden now */}
                <div className="mt-3 h-fit w-fit rounded-full bg-darkMuted px-4 py-1 md:px-5 md:py-2 xl:px-9 xl:py-3">
                    <span className="text-lg text-light md:text-xl xl:text-2xl">{price}</span>
                </div>
            </div>
        </div>
    );
